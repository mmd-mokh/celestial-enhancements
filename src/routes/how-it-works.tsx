...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      { title: "چطور کنسول اجاره کنیم؟ راهنمای ۴ مرحله‌ای | کنسولتو" },
      {
        name: "description",
        content:
          "اجاره کنسول در کنسولتو در ۴ مرحله ساده: انتخاب کنسول، انتخاب پکیج، ثبت درخواست، و تحویل درب منزل. کمتر از ۳۰ دقیقه پاسخگویی.",
      },
      { property: "og:title", content: "راهنمای اجاره کنسول در کنسولتو" },
      {
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          step: [
            ...
            { "@type": "HowToStep", position: 4, name: "بازی کن و لذت ببر", text: "روشن کن و بازی کن. پشتیبانی ۲۴/۷ کنسولتو کنارت است." },
          ],
        }),
      },
      {
...
const STEPS = [
  ...
  { Icon: PackageCheck, title: "۲. ثبت درخواست", body: "فرم رزرو را در کمتر از ۳ دقیقه پر کن. تیم کنسولتو در کمتر از ۳۰ دقیقه با تو تماس می‌گیرد." },
  ...
  { Icon: Gamepad2, title: "۴. بازی کن و لذت ببر", body: "کافی است روشن کنی و بازی کنی. پشتیبانی ۲۴/۷ کنسولتو در تمام مدت اجاره کنارت است." },
];
