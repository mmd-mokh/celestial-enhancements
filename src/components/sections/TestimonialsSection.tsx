...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    img: "/assets/images/people/man.webp",
    quote:
      "واقعاً عالی بود! با بودجه محدود دانشجویی نمی‌تونستم PS5 بخرم، ولی با کنسولتو تونستم برای آخر هفته با دوستام اجاره کنم. کنسول تمیز و سالم بود، تحویل سر وقت، و قیمتش خیلی منطقی. حتماً دوباره استفاده می‌کنم. ممنون کنسولتو!",
  },
  {
    name: "سارا",
    meta: "مادر دو فرزند، ۳۵ سال",
    img: "/assets/images/people/women.webp",
    quote:
  ...
  },
  {
    ...
    img: "/assets/images/people/man2.webp",
    quote:
      "من قبل از خرید Xbox Series X می‌خواستم ببینم واقعاً ارزشش رو داره یا نه. یه هفته از کنسولتو اجاره کردم و تمام بازی‌های Game Pass رو تست کردم. کیفیت کنسول عالی بود، انگار نو بود. الان مطمئنم که می‌خوام بخرمش. ممنون که این امکان رو دادین. خدمات حرفه‌ای و قابل اعتماد.",
  },
];
  ...
  return (
    <SectionShell id="testimonials" bg="gray">
      <SectionHeading
        ...
        title="گیمرها درباره کنسولتو چی می‌گن؟"
      />
