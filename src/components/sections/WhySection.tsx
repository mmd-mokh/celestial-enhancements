...
const BENEFITS: Array<{ icon: string; title: string; body: string }> = [
  {
    ...
    body:
      "چرا ۳۰ میلیون تومان برای PS5 بدی وقتی می‌تونی با کسری از این مبلغ، هر ماه کنسول جدیدی رو تجربه کنی؟ با کنسولتو، بودجه‌ات رو برای بازی‌های بیشتر و تجربه‌های متنوع‌تر نگه دار.",
  },
  {
    icon: "bi-shuffle",
  ...
  },
  {
    ...
    body:
      "جشن تولد داری؟ دوستات میان خونه؟ تعطیلات نوروز؟ با اجاره کنسول از کنسولتو، هر جمع‌ای رو به یه تجربه فراموش‌نشدنی تبدیل کن. سرگرمی حرفه‌ای برای همه سنین.",
  },
  {
    icon: "bi-check-circle-fill",
    title: "مطمئن شو قبل از اینکه سرمایه‌گذاری کنی",
    body:
      "نمی‌دونی PS5 بگیری یا Xbox؟ نینتندو سوییچ واقعاً برات مناسبه؟ با اجاره از کنسولتو، اول امتحان کن، بعد تصمیم بگیر. ریسک صفر، اطمینان صد درصد.",
  },
  {
    icon: "bi-truck",
    ...
    <SectionShell id="why-choose" ariaLabelledBy="why-choose-heading" bg="gray">
      <div className="mt-8 flex flex-col place-items-center gap-5">
        <SectionHeading
          ...
          title="چرا کنسولتو بهترین انتخابه؟"
